...
@Component({
  selector: 'app-component-expense-type',
  templateUrl: './expenseType.component.html'
})
export class ExpenseTypeComponent implements AfterViewInit{
  data: ExpenseTypeModel[];
  confirm: ConfirmModel;
  formPop: PopUpModel;
  selectedItem: ExpenseTypeModel;
  ...
  Edit(): void {
    const item: ExpenseTypeModel = this.GetSelectedItem();
  ...
  Save(model: ExpenseTypeModel): void {
    this.Blocker.block = true;
  ...
  private SaveData(item: ExpenseTypeModel): void {
  ...
  private UpdateData(item: ExpenseTypeModel): void {
  ...
  private DeleteData(item: ExpenseTypeModel): void {
  ...
  private GetSelectedItem(): ExpenseTypeModel {
